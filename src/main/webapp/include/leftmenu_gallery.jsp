...
<ul class="leftmenu">
	<li><a href="../community/list.jsp?tname1=photogallery">포토갤러리<i class="fa fa-angle-right"></i></a></li>
    <li><a href="../community/list.jsp?tname1=videogallery">영상갤러리 <i class="fa fa-angle-right"></i></a></li>
</ul>
