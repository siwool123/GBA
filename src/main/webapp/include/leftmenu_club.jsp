...
<ul class="leftmenu">
	<li><a href="../community/list.jsp?tname1=activity">소속클럽현황<i class="fa fa-angle-right"></i></a></li>
    <li><a href="../community/list.jsp?tname1=news">클럽소식 <i class="fa fa-angle-right"></i></a></li>
</ul>
